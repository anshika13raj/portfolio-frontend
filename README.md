...
This project showcases my work in **Web Development**, **AI**, and **Data Science** — focusing on design simplicity, responsiveness, and clean structure.  
Each section (About, Projects, Contact) is modular and built using **container-based layout** for scalability and smooth navigation.
...
| 🧠 **Speech Emotion Detection (GRU)** | GRU-based model for emotion classification. | TensorFlow, Python |
| 🤖 **RAG Chat Engine** | Retrieval-augmented chatbot for document-based Q&A. | Node.js, React, Gemini API |
| 📊 **Healthcare Power BI Dashboard** | Power BI dashboard analyzing 10K+ patient records. | Power BI, Excel |
...
📈 Future Enhancements
🌟 Integrate EmailJS for contact form submissions

📰 Add a Blog / Achievements section

💬 Include AI-based assistant or chatbot

⚡ Add GSAP / Framer Motion animations for smoother transitions
